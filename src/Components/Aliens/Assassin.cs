...
public class Assassin : AlienBase
{
    ...
    public override int Points { get; set; } = 30;
    ...
    public Assassin(Vector2 position)
    {
        _position = position;
    ...
    {
        Texture = content.Load<Texture2D>("Sprites/Aliens/Assassin");
